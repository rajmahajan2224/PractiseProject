...
public class FootballClubRecordFileHandling {
	...
	public static void main(String [] args) {
		...
		while( cont.equalsIgnoreCase("y") ) {        	
     	   System.out.println("\t\t AFC Football Club\n\n");
     	   
     	   System.out.println("1 ====> Add New Player Record to club");
     	   System.out.println("2 ====> View all Player Record present in the club");
     	   System.out.println("3 ====> Delete Player Record leave the club");
     	   System.out.println("4 ====> Search Player Record");
     	   System.out.println("5 ====> Update Player Record in the club");
